...
<body>
    <div style="min-height: 100vh; display: flex; align-items: center; justify-content: center; background: var(--theme-bg);">
        <div style="max-width: 500px; text-align: center; padding: 30px; background: var(--theme-surface-strong); border-radius: 20px; box-shadow: var(--theme-shadow); margin: 20px;">
            ...
            <a href="{{ url('/orders') }}" style="display: inline-block; padding: 15px 40px; background: var(--theme-accent); color: var(--theme-accent-contrast); text-decoration: none; border-radius: 15px; font-weight: 400;">
                Перейти к заказам
            </a>
            <br>
            <a href="{{ url('/gallery') }}" style="display: inline-block; margin-top: 15px; color: var(--theme-muted); text-decoration: none;">
                Вернуться в галерею
            </a>
        </div>
    </div>
