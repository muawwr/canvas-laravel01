...
<main class="add_main container" data-managed-add-page="custom" @if($auctionFromPicture) data-auction-conversion="true" @endif>
    <div class="add_modal active" data-step="1">
        <div class="add_modal_content">
            ...
            <label class="add_label add_upload_label" for="imageUpload">Изображение картины <span class="required-star">*</span></label>
        ...
        <div class="add_modal_content">
            ...
            <div class="listing_panel {{ $auctionFromPicture ? 'active' : '' }}" data-listing-panel="auction">
                <div class="add_section">
                    ...
                    <input type="number" class="add_input add_input_full" placeholder="Введите стартовую цену" id="auctionStartPrice" min="100" required>
                    <div class="field_error" id="auctionStartPriceError"></div>
                </div>

                <div class="add_row">
                    <div class="add_section add_section_half">
                        <label class="add_label" for="auctionMinStep">Минимальный шаг, ₽ <span class="required-star">*</span></label>
                        <input type="number" class="add_input" placeholder="Например, 500" id="auctionMinStep" min="50" value="500" required>
                ...
                <div class="add_section">
                    <label class="add_label" for="auctionDurationHours">Таймер аукциона <span class="required-star">*</span></label>
                    <select class="add_input add_input_full add_timer_select" id="auctionDurationHours" required>
