...
<main>
    <div class="one_product container">
        <div>
            <a class="btn_back" href="{{ $backUrl }}"><img src="{{ asset('assets/images/oneProduct/back.svg') }}" alt="Назад"></a>
        </div>
            ...
            @if($picture->listing_type !== 'auction')
                <div class="product_buttons">
                    @if(session()->has('user_id') && session('user_id') == $picture->user_id)
                        ...
                        @unless($is_sold)
                            <a href="{{ url('/add?auction_from=' . $picture->id) }}" class="auction_product_btn">
                                Добавить в аукцион
                            </a>
                        @endunless
                    @else
    ...
    <div class="delete_modal">
        ...
        <div class="delete_buttons">
            <button class="delete_btn delete_btn_back" onclick="closeDeleteModal()">
                <img src="{{ asset('assets/images/add/Left.svg') }}" alt="Назад"> Назад
            </button>
