            ...
            <form action="<?php echo e(url('/reg')); ?>" method="POST" novalidate>
                ...
                <div class="form_inputs">
                    ...
                    <div class="input_group <?php echo e($errors->has('name') ? 'error' : ''); ?>">
                        ...
                        <input type="text" id="registerName" name="name" placeholder="Отображаемое имя" value="<?php echo e(old('name')); ?>" autocomplete="off" required>
                    </div>
                    ...
                    <div class="input_group <?php echo e($errors->has('email') ? 'error' : ''); ?>">
                        ...
                        <input type="email" id="registerEmail" name="email" placeholder="Электронная почта" value="<?php echo e(old('email')); ?>" autocomplete="off" required>
                    </div>
