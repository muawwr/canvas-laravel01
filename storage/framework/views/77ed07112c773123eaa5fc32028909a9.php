    ...
    <div class="step_fields" style="max-width: 600px; margin: 0 auto;">
        <div class="field_group">
            ...
            <div class="upload_area" id="uploadArea" style="max-height: 300px;">
                <img id="previewImage" class="upload_preview" src="<?php echo e(asset($picture->img)); ?>" style="display: block; max-height: 280px; object-fit: contain;">
        ...
        <div class="field_row">
            <div class="field_group">
                ...
                <input type="number" class="field_input" id="widthInput" value="<?php echo e($picture->width); ?>" min="1">
            </div>
            <div class="field_group">
                <label class="field_label">Высота (см)</label>
                <input type="number" class="field_input" id="heightInput" value="<?php echo e($picture->height); ?>" min="1">
            </div>
        </div>
        <div class="field_group">
            <label class="field_label">Название</label>
            <input type="text" class="field_input" id="nameInput" value="<?php echo e($picture->name); ?>" maxlength="255">
        </div>
        <div class="field_group">
            <label class="field_label">Техника</label>
            <input type="text" class="field_input" id="techniqueInput" value="<?php echo e($picture->technique); ?>" maxlength="255">
        </div>
        <div class="field_group">
            <label class="field_label">Год</label>
            <input type="number" class="field_input" id="yearInput" value="<?php echo e($picture->year); ?>" min="1000" max="<?php echo e(date('Y')); ?>">
        </div>
        <div class="field_group">
            <label class="field_label">Описание</label>
            <textarea class="field_textarea" id="descriptionInput" rows="4" maxlength="5000"><?php echo e($picture->description); ?></textarea>
        </div>
        <div class="field_group">
            <label class="field_label">Жанр</label>
            <select class="field_input" id="genreSelect">
                <?php $__currentLoopData = $genres; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $genre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($genre->id); ?>" <?php echo e($picture->genre_id == $genre->id ? 'selected' : ''); ?>><?php echo e($genre->name); ?></option>
        ...
        <div class="field_group">
            ...
            <select class="field_input" id="styleSelect">
                ...
                <option value="<?php echo e($style->id); ?>" <?php echo e($picture->style_id == $style->id ? 'selected' : ''); ?>><?php echo e($style->name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
        <div class="field_group">
            ...
            <select class="field_input" id="eraSelect">
                ...
                <option value="<?php echo e($era->id); ?>" <?php echo e($picture->era_id == $era->id ? 'selected' : ''); ?>><?php echo e($era->name); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
        <div class="field_group">
            <label class="field_label">Цена (₽)</label>
            <input type="number" class="field_input" id="priceInput" value="<?php echo e($picture->price); ?>" min="100">
        </div>
        <div class="wizard_buttons" style="margin-top: 20px;">
            <a href="<?php echo e(url('/picture/' . $picture->id)); ?>" class="wizard_btn wizard_btn_back"><img src="<?php echo e(asset('assets/images/add/Left.svg')); ?>" alt="Back"> Назад</a>
            <button class="wizard_btn wizard_btn_next" id="saveBtn">Сохранить <img src="<?php echo e(asset('assets/images/add/Right.svg')); ?>" alt="Save"></button>
        </div>
    </div>
</main>
...
document.getElementById('saveBtn').addEventListener('click', async function() {
    ...
    formData.append('picture_id', <?php echo e($picture->id); ?>);
    ...
    try {
        ...
        if (result.success) { showToast('Картина обновлена'); setTimeout(() => window.location.href = '/picture/<?php echo e($picture->id); ?>', 1500); }
