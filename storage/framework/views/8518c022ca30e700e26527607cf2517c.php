...
<script>
    const pictureId = <?php echo e($picture->id); ?>;
    let newImageFile = null;

    const formState = {
        genre_id: <?php echo e($picture->genre_id); ?>,
        style_id: <?php echo e($picture->style_id); ?>,
        era_id: <?php echo e($picture->era_id); ?>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        document.getElementById('editSuccessOkBtn').addEventListener('click', () => {
            window.location.href = '/picture/<?php echo e($picture->id); ?>';
        });
    });
</script>
<?php $__env->stopSection(); ?>
