        ...
        <div class="add_modal_content">
            ...
            <div class="add_section">
                ...
                <div class="add_size_inputs">
                    <input type="number" id="pictureWidth" class="add_input" placeholder="Ширина" min="1" value="<?php echo e(old('width')); ?>">
                    <span class="size_separator">x</span>
                    <input type="number" id="pictureHeight" class="add_input" placeholder="Высота" min="1" value="<?php echo e(old('height')); ?>">
                </div>
            ...
            <div class="add_section">
                ...
                <input type="text" id="pictureName" class="add_input add_input_full" placeholder="Введите название картины" maxlength="255" value="<?php echo e(old('name')); ?>">
        ...
        <div class="add_modal_content">
            ...
            <div class="add_row">
                <div class="add_section add_section_half">
                    ...
                    <input type="text" id="pictureTechnique" class="add_input" placeholder="Гуашь, пастель" maxlength="255" value="<?php echo e(old('technique')); ?>">
                    <div class="field_error" id="pictureTechniqueError"></div>
                </div>
                <div class="add_section add_section_half">
                    <label class="add_label" for="pictureYear">Год написания</label>
                    <input type="number" id="pictureYear" class="add_input" placeholder="ГГГГ" min="1000" max="<?php echo e(date('Y')); ?>" value="<?php echo e(old('year')); ?>">
            ...
            <div class="add_section">
                ...
                <textarea id="pictureDescription" class="add_textarea" placeholder="Введите описание картины"><?php echo e(old('description')); ?></textarea>
