            ...
            <div class="header-gallery-content">
                ...
                <div class="header-gallery-nav">
                    ...
                    <div class="search-bar search-bar-collapsed" id="gallerySearchBar">
                        ...
                        <input type="text" id="searchInput" placeholder="Поиск" value="<?php echo e(request('search', '')); ?>">
                    </div>
                </div>
                ...
                <div class="filter-sections">
                    <div class="filter-section">
                        ...
                        <div class="filter-options">
                            ...
                            <label class="filter-option">
                                <input type="checkbox" class="filter-checkbox" data-filter-type="genre" data-filter-id="<?php echo e($genre->id); ?>" style="display: none;" <?php echo e((string) request('genre_id') === (string) $genre->id ? 'checked' : ''); ?>>
                    ...
                    <div class="filter-section">
                        ...
                        <div class="filter-options filter-columns">
                            ...
                            <div class="filter-column">
                                ...
                                <label class="filter-option">
                                    <input type="checkbox" class="filter-checkbox" data-filter-type="style" data-filter-id="<?php echo e($style->id); ?>" style="display: none;" <?php echo e((string) request('style_id') === (string) $style->id ? 'checked' : ''); ?>>
                    ...
                    <div class="filter-section">
                        ...
                        <div class="filter-options">
                            ...
                            <label class="filter-option">
                                <input type="checkbox" class="filter-checkbox" data-filter-type="era" data-filter-id="<?php echo e($era->id); ?>" style="display: none;" <?php echo e((string) request('era_id') === (string) $era->id ? 'checked' : ''); ?>>
                    ...
                    <div class="filter-section">
                        ...
                        <div class="filter-options back">
                            <label class="filter-option radio-option">
                                <input type="radio" name="price-sort" value="price-asc" <?php echo e(request('sort') === 'price_asc' ? 'checked' : ''); ?>>
                                <span>Цена ↗</span>
                            </label>
                            <label class="filter-option radio-option">
                                <input type="radio" name="price-sort" value="price-desc" <?php echo e(request('sort') === 'price_desc' ? 'checked' : ''); ?>>
                                <span>Цена ↘</span>
                            </label>
                            <label class="filter-option radio-option">
                                <input type="radio" name="additional-sort" value="popularity" <?php echo e(request('sort') === 'popular' ? 'checked' : ''); ?>>
                                <span>Популярность</span>
                            </label>
                            <label class="filter-option radio-option">
                                <input type="radio" name="additional-sort" value="newest" <?php echo e(request('sort', 'newest') === 'newest' ? 'checked' : ''); ?>>
                                <span>Новизна</span>
                            </label>
                        </div>
                    </div>
