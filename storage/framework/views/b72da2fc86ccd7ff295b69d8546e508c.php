...
<main class="auction_workspace container">
    <?php if($isBlocked ?? false): ?>
        <div class="blocked-cart-state" data-auction-banned-until="<?php echo e(optional($bannedUntil)->toIso8601String()); ?>">
            <h3>Вам ограничен доступ</h3>
            <p><?php echo e($restrictionMessage); ?></p>
            <div class="blocked_timer_box">
                <strong id="auctionBlockedCountdown"><?php echo e(optional($bannedUntil)->format('d.m.Y H:i')); ?></strong>
            </div>
        </div>
    <?php else: ?>
        <div class="auction_workspace_title">
            <h1>Аукцион:</h1>
            <span data-auction-count><?php echo e($auctions->count()); ?></span>
        </div>

        <?php if($auctions->isNotEmpty()): ?>
            <div class="auction_workspace_layout">
                <section class="auction_lots_list" aria-label="Картины на аукционе">
                    <?php $__currentLoopData = $auctions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $picture): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <button
                        class="auction_lot_card <?php echo e($loop->first ? 'active' : ''); ?> <?php echo e($isFinished ? 'finished' : ''); ?>"
                        type="button"
                        data-auction-lot
                        data-picture-id="<?php echo e($picture->id); ?>"
                        data-name="<?php echo e($picture->name); ?>"
                        data-author="<?php echo e($picture->user->name ?? 'Неизвестный автор'); ?>"
                        data-image="<?php echo e(asset($picture->img)); ?>"
                        data-current-price="<?php echo e($currentPrice); ?>"
                        data-min-step="<?php echo e($minStep); ?>"
                        data-next-bid="<?php echo e($minNextBid); ?>"
                        data-bids-count="<?php echo e($picture->auction_bids_count); ?>"
                        data-buyout-price="<?php echo e($picture->auction_buyout_price ?? ''); ?>"
                        data-ends-at="<?php echo e($endsAt ? $endsAt->toIso8601String() : ''); ?>"
                        data-is-finished="<?php echo e($isFinished ? '1' : '0'); ?>"
                        data-is-auth="<?php echo e(session()->has('user_id') ? '1' : '0'); ?>"
                        data-is-owner="<?php echo e(session('user_id') == $picture->user_id ? '1' : '0'); ?>"
                        data-is-blocked="<?php echo e(($isBlocked ?? false) ? '1' : '0'); ?>"
                        data-blocked-message="<?php echo e($restrictionMessage ?? ''); ?>"
                        data-user-status="<?php echo e($userStatus); ?>"
                        data-leader-name="<?php echo e($leaderName); ?>"
                    >
                        ...
                        <span class="auction_lot_image">
                            ...
                            <span data-lot-timer data-ends-at="<?php echo e($endsAt ? $endsAt->toIso8601String() : ''); ?>"><?php echo e($isFinished ? 'Завершен' : '...'); ?></span>
                        </span>

                        <span class="auction_lot_content">
                            <span class="auction_lot_top">
                                <span>
                                    <strong><?php echo e($picture->name); ?></strong>
                                    <small><?php echo e($picture->user->name ?? 'Неизвестный автор'); ?></small>
                                </span>
                                <span class="auction_lot_tags">
                                    <?php if($picture->genre): ?>
                                        <em><?php echo e($picture->genre->name); ?></em>
                                    <?php endif; ?>
                                    <?php if($picture->style): ?>
                                        <em><?php echo e($picture->style->name); ?></em>
                                    <?php endif; ?>
                                    <?php if($picture->era): ?>
                                        <em><?php echo e($picture->era->name); ?></em>
                                    <?php endif; ?>
                                </span>
                            </span>

                            <span class="auction_lot_specs">
                                <span><b>Техника</b><i><?php echo e($picture->technique); ?></i></span>
                                <span><b>Размеры</b><i><?php echo e($picture->width); ?> x <?php echo e($picture->height); ?> см</i></span>
                                <span><b>Год</b><i><?php echo e($picture->year); ?></i></span>
                            </span>
                        </span>
                    </button>
